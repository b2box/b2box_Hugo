...
// Config alineada al B2BOX Design System (mismo que Pro/App): tokens shadcn
// mapeados a variables CSS HSL definidas en src/index.css.
export default {
  darkMode: ["class"],
  ...
  theme: {
    ...
    extend: {
      screens: { xs: "475px" },
      fontFamily: {
        // Fonts del sistema, igual que Paco APP (--sans / --mono).
