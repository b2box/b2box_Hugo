// Iconos SVG (estilo Lucide) portados del index.html original, como
// componentes React. Todos heredan `currentColor` y aceptan className.
...
// Iconos de las tarjetas de métricas (más geométricos)
export function IconBox({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <path d="M21 7.5l-9 5.25L3 7.5" />
...
export function IconWarnFill({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
      <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" />
...
export function IconCopySquare({ className }: IconProps) {
  return (
    <svg {...base} className={className}>
...
export const SECTION_ICON: Record<string, ComponentType<IconProps>> = {
  ...
  duplicates: IconCopy,
  price_changes: IconTrending,
  sent_to_paco: IconSend,
  paco_errors: IconAlertCircle,
  quality_issues: IconAlertTriangle,
  quality_no_image: IconImageOff,
